...
<%
	...
	System.out.println("/mypage/order_approval.jsp site_cd::::::::::: " + siteCode);
	System.out.println("/mypage/order_approval.jsp orderID::::::::::: " + orderID);
	System.out.println("/mypage/order_approval.jsp paymentAmount::::: " + paymentAmount);
	System.out.println("/mypage/order_approval.jsp paymentMethod::::: " + paymentMethod);
	System.out.println("/mypage/order_approval.jsp response_type::::: " + response_type);
	System.out.println("/mypage/order_approval.jsp escrow:::::::::::: " + escrow);
	System.out.println("/mypage/order_approval.jsp Ret_URL::::::::::: " + Ret_URL);
	System.out.println("/mypage/order_approval.jsp productName::::::: " + productName);
    ...
    out.println( suc.kcpPaymentSmartPhone( request, g_conf_server, pd, "c:\\" ) ); // 이클립스 상에서 메서드를 클릭 후 F2를 누르면 상세 내용이 나옵니다.
%>