...
<form name="submitParam" method="post" enctype="multipart/form-data" onSubmit="return false;">
	...
	<input type="hidden" name="ordNo1" 		id="ordNo1"    value="${detailMap.ordNo}"/>
    	...
    	<main class="mynexen">
        	<!-- header -->
          	<div class="page-header empty">
            	...
            	<h3 class="title-deco-sub">조기 마모 보증 신청</h3>
          	</div>
          	<!-- //header -->

          	<div class="order-middle-message text-center">
            	<p>고객님께서 직접 무상 파손/조기 마모 보증 서비스 신청 및 신청내역을 조회할 수 있습니다</p>
          	</div>
          	...
          	<div class="mynexen-payment-product bg">
            	<div class="order-info-summary-wrap">
              		<div class="order-info-summary col-1">
                		<small>계약일<span id="ordDay2"></span></small>
                		<%-- <small>
                			계약번호
                	...
                	<div class="layout-r same-size">
                    	...
                    	<div class="inlnie border-bottom order-box">
                      		<div class="order-data-title">
                        		<h3>${detailMap.patternCd}</h3>
                      		</div>
                      		<div class="order-product-info">
                        		<ul class="mb-s">
                          			<li><span>${detailMap.matNm}</span></li>
                          			<li><span>${detailMap.makerNm}</span><span>${detailMap.modelNm}</span></li>
                        		</ul>
                      		</div>
                    	</div>
                  	</div>
                  	...
                  	<div class="layout-c mt-m">
                    	<div class="layout-r inline-s order-rent">
                      		<div class="order-count inline align-middle">
                        		<b class="align-middle">수량</b> <span>${detailMap.cntCd}</span>
                      		</div>
                      		<div class="order-rent-info" style="display:none;">
                        		<dl class="layout-r">
                          			<dt>렌탈기간</dt>
                          			<dd>월 렌탈료</dd>
                          			<dd><fmt:formatNumber value="${detailMap.sumMonAmt}" pattern="#,###" /></dd>
                        		</dl>
                        		<dl class="layout-r">
                          			<dt><b>${detailMap.periodCd}개월</b></dt>
                          			<dd>렌탈 등록비</dd>
                          			<dd><fmt:formatNumber value="${detailMap.regiAmt}" pattern="#,###" /></dd>
                        		</dl>
                      		</div>
                    	</div>
                  	</div>
          	...
          	<div class="product-sub-info rental accordion-box js-accordion">
            	...
            	<div class="accordion-info inset-ml">
              		<div class="submit layout-c mb-m border-bottom">
                		...
                		<p class="pt-s pb-s" name="ordNo1" id="ordNo1" class="type03" value="${detailMap.ordNo}" readonly>${detailMap.ordNo}</p>
              		</div>
              		<div class="submit layout-c mb-m border-bottom">
              		...
              		<div class="submit layout-c border-bottom">
                		...
                		<div class="order-basket">
                  			<select name="KWMENG" id="KWMENG" onchange="goKwmeng(this.value)" title="신청 타이어 개수 선택">
            	...
            	<div class="accordion-info inset-ml">
					...
					<div class="dam-notic3">
						...
						<ul>
							...
							<li>계기판 사진은 차량의 누적 주행거리가 노출되어야 합니다. <br/>(TRIP 제외)</li>
            	...
            	<div class="accordion-info inset-ml">
                	<div class="order-basket">
						...
						<input type="hidden" name="smsMsg" 			id="smsMsg" />
						<input type="hidden" name="mounting" 		id="mounting"     value="40"/>
                			...
                			<div class="conWrap js-radioUI mt-s">
                  				<ul style="width:-webkit-fill-available">
                    				<li class="radio col-2">
                      					<input type="radio" name="mounting" id="ser1" value="10" class="radioChk" title="방문장착서비스 선택">
                    				...
                    				<li class="radio col-2">
                      					<input type="radio" name="mounting" id="ser3" checked="checked" value="40" class="radioChk" title="전문점 장착 서비스 선택">
...
function fn_InsertProc(){
	...
	*/
	...
	if(confirm("신청하시겠습니까?")){
		...
		fParam.append("cMileage", 	$('#carMileage').val());
