    ...
    <div class="subContentsWrap">
    	<main class="mynexen">
        	<!-- header -->
          	...
          	<div class="btn-wrap">
	        	<button type="button" class="btn-primary inset-m full-width" onclick="javascript:fn_insertFreeDamageSrvUpload();">가입 신청</button>
	        </div>
		</main>
...
// 무상 파손 보증 서비스 신청 업로드 하기
function fn_insertFreeDamageSrvUpload() {

    var formData = new FormData();
	var pUrl = "/mypage/insertFreeDamageSrvUpload";
