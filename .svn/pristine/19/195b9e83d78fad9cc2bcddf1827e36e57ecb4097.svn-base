...
<!-- 				</div> -->
		...
		<div class="find-size">
			<div class="find-size-warp">
				<div><a onclick="chkCarNum(document.getElementById('mainSizeNumInput'))"><img src="/img/main/main_button_01.jpg" alt="" /></a></div>
				<div><a onclick="openSizeFinder( 'car' );"><img src="/img/main/main_button_02.jpg" alt="" /></a></div>
				<div><a onclick="openSizeFinder( 'size' );"><img src="/img/main/main_button_03.jpg" alt="" /></a></div>
			</div>
