    	...
    	<main class="mynexen">
        	<!-- header -->
          	<div class="page-header empty">
            	...
            	<h3 class="title-deco-sub">무상 파손 보증 서비스 신청</h3>
          	</div>
          	<!-- //header -->
...
<%--                 		<small>
                			...
                			&nbsp;<font color="red">${detailMap.dlvstatNm}</font>
                		</small> --%>
              		</div>
            	</div>
            	...
            	<div class="accordion-info inset-ml">
					...
					<div class="tire-item-container">
						...
						<div class="tire-item item-3">
							...
							<div class="tire-block">
								<h4>타이어 전륜(좌)</h4>
								<div class="tire-thumb"><img src="/img/mypage/sample/tire_damage_front_left.png"> <button type="button" class="img-zoom"></button></div>
								<div class="tire-actions">
									<div class="upload-box">
						...
						<div class="tire-item item-4">
							<div class="tire-block">
								<h4>타이어 전륜(우)</h4>
								<div class="tire-thumb"><img src="/img/mypage/sample/tire_damage_front_right.png"> <button type="button" class="img-zoom"></button></div>
								<div class="tire-actions">
									<div class="upload-box">
						...
						<div class="tire-item item-5">
							<div class="tire-block">
								<h4>타이어 후륜(좌)</h4>
								<div class="tire-thumb"><img src="/img/mypage/sample/tire_damage_rear_left.png"> <button type="button" class="img-zoom"></button></div>
								<div class="tire-actions">
									<div class="upload-box">
						...
						<div class="tire-item item-6">
							<div class="tire-block">
								<h4>타이어 후륜(우)</h4>
								<div class="tire-thumb"><img src="/img/mypage/sample/tire_damage_rear_right.png"> <button type="button" class="img-zoom"></button></div>
								<div class="tire-actions">
									<div class="upload-box">
						...
						<div class="submit list timePick">
              			...
              			<div class="submit">
							...
							<div class="dam-notic2">
								...
								<ol>
									<li>1. 무상 파손 보증 서비스 조건(계약기간 내 운행 중 파손 시, 무상 교체)에 부합하지 않을 시, 서비스가 제한됩니다.</li>
									<li>2. 고의 파손 또는 파손된 타이어 사진 식별이 불가능한 경우 서비스가 제한됩니다.</li>
									<li>3. 타이어는 회사 사정에 따라 제품이 변경되어 지급될 수 있습니다.(사이즈 동일)</li>
									<li>4. 연체중인 경우 서비스 신청이 제한 될 수 있습니다.</li>
									<li>5. 회사에서 무상제공하는 모든 타이어는 렌탈 타이어 본 품 수량에 한합니다.</li>
								</ol>
							</div>
...
function fn_InsertProc(){
	...
	*/
	...
	if(confirm("신청하시겠습니까?")){
		ComUtil.loading();
		var pUrl = "/mypage/insertFreeDamageReq";
