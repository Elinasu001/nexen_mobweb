              		...
              		<div class="submit border-bottom">
                		...
                		<div class="dateTime layout-r same-size">
                  			...
                  			<c:if test="${data.statCd eq '01' and o2oShopYn eq 'Y'}">
								<div class="btn w100">
		                        	<button type="button" onclick="javascript:fn_changeDtPop('${data.ordNo}');" class="round payment" style="background-color:#801494"><span>변경</span></button>
		                        </div>
		                    </c:if>
                		</div>
              		</div>
              				...
              				<p class="black">카드정보</p>
           					<div class="layout-r inline-m border-bottom">
             					<c:if test="${data.cardcomNm != null and data.cardcomNm != ''}">
             						...
             						<p class="pt-s pb-s inline">${fn:substring(data.cardNo, 0 ,4)}********</p>
             					</c:if>
           					</div>
            			</div>
            			...
            			<div class="submit layout-c">
              				...
              				<div class="layout-r inline-m border-bottom">
                				<c:if test="${data.bankNm != null and data.bankNm != ''}">
                					...
                					<p class="pt-s pb-s inline">${fn:substring(data.acctNo, 0 ,4)}********</p>
                				</c:if>
              				</div>
            			</div>
