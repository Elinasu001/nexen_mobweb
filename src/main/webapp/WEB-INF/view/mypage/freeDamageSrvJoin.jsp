    	...
    	<main class="mynexen">
        	<!-- header -->
          	<div class="page-header empty">
            	<h2 class="title-deco">
              		<span>무상 파손 보증 서비스 가입</span>
            	</h2>
            	<h3 class="title-deco-sub">무상 파손 보증 서비스 가입</h3>
          	</div>
          	<!-- //header -->
          	...
          	<div class="btn-wrap">
	        	<button type="button" class="btn-primary inset-m full-width" onclick="javascript:fn_insertFreeDamageSrv();">가입 등록</button>
	        </div>
		</main>
...
$( document ).ready(function() {
	...
	$.ajax({
	    ...
	    success: function(data) {
	    	console.log(data);
	    	console.log(data.b00012UseCnt);
	    	console.log(data.registIngYn);
			//url로 호출했는데 가입 안 한 경우
	    	if(data.url == 1 && data.b00012UseCnt == -1 && data.registIngYn == "N") {
				return true;
	    	...
	    	}else if(data.url == 1 && data.b00012UseCnt >= 0){
