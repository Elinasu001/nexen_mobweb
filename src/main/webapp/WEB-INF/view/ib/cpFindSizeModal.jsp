	...
	<div class="modal-wrap">
		...
		<div class="size-tab type-num step-01">
			...
			<div id="noticeDiv" style="display:none;">
				...
				<p style="text-align:left; line-height:25px; word-spacing:5px; padding-left:50px; font-size:1.0em;">
					<b>
					- 2021-05-28 22:00 ~ <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2021-05-29 07:00 (예정)<br>
					<br>
					</b>
				</p>
				<p style="text-align:center; line-height:25px; word-spacing:5px; font-size:1.0em;">
		...
		<div class="size-tab type-num step-02" >
			...
			<div class="btn-wrap">
				...
				<a id="findSizeNumRetryCopy" data-clipboard-text="" class="retry" style="margin: 10px auto 10px auto;">복사</a>
				<a href="https://link.coupang.com/nt/ECOMMSRP?pageKey=%EB%84%A5%EC%84%BC%ED%83%80%EC%9D%B4%EC%96%B4" class="submit" >쿠팡으로 가기</a>
			</div>
		</div>
		...
		<div class="size-tab type-car step-02" >
			...
			<div class="btn-wrap">
				...
				<a id='findSizeCarCopy' class="retry" style="margin: 10px auto 10px auto;">복사</a>
				<a href="https://link.coupang.com/nt/ECOMMSRP?pageKey=%EB%84%A5%EC%84%BC%ED%83%80%EC%9D%B4%EC%96%B4" class="submit" >쿠팡으로 가기</a>
			</div>
		</div>
		...
		<div class="size-tab type-size step-02" >
			...
			<div class="btn-wrap">
				...
				<a id="findCarSizeCopy" data-clipboard-text="" class="retry" style="margin: 10px auto 10px auto;">복사</a>
				<a href="https://link.coupang.com/nt/ECOMMSRP?pageKey=%EB%84%A5%EC%84%BC%ED%83%80%EC%9D%B4%EC%96%B4" class="submit" >쿠팡으로 가기</a>
		...
		<div class="size-tab type-size step-03" >
			...
			<div class="btn-wrap">
				...
				<a id="findCarSizeCopy2" data-clipboard-text="" class="submit" style="margin: 10px auto 10px auto;">복사</a>
				<a href="https://link.coupang.com/nt/ECOMMSRP?pageKey=%EB%84%A5%EC%84%BC%ED%83%80%EC%9D%B4%EC%96%B4" class="submit" >쿠팡으로 가기</a>
			</div>
		</div>
	</div>
...
// 차량번호로 조회시 복사
$("#findSizeNumRetryCopy").on('click',function(){
    ...
    var carInfo;
    if(fwdArry != rwdArry) {
    	carInfo = "전륜-" + fwdArry + " 후륜-" + rwdArry;
    } else {
    	carInfo = fwdArry;
    }
	
	var clipboard = new ClipboardJS('#findSizeNumRetryCopy');
	$(this).attr('data-clipboard-text',  carInfo);
...
$("#findSizeCarCopy").on('click',function(){
	...
	var clipboard = new ClipboardJS('#findSizeCarCopy');
	$(this).attr('data-clipboard-text',  carInfo);
...
$("#findCarSizeCopy, #findCarSizeCopy2").on('click',function(){
	...
	var clipboard = new ClipboardJS('#findCarSizeCopy');
	var clipboard2 = new ClipboardJS('#findCarSizeCopy2');
	$(this).attr('data-clipboard-text',  carInfo);
