	            	...
	            	<div class="submit layout-c mb-m border-bottom">
	              	...
	              	<div class="submit layout-c">
	                	...
	                	<div class="conWrap layout-r border-bottom mb-s">
							...
							<input type="text"  name="addrtxt" class="type03 trans-bg" id="addrtxt" title="주소 입력란" placeholder="주소를 검색하세요" value="${userVo.addr1} ${userVo.addr2}" >
	            ...
	            <div class="accordion-info inset-ml">
                    ...
                    <input type="hidden" id="inst2Addr2" name="inst2Addr2"> <!-- Deliver 주소-상세주소 -->
	              	...
	              	<div class="submit">
	                	...
	                	<div class="conWrap mb-s">
	                  		<div class="dateTime layout-r same-size border-bottom">
	                    		<div class="date pl-ml inline">
	                      			<input type="text" name="reqInsDt" id="datepicker11" title="장착 희망일시 입력란" readonly="readonly"><!-- PC에서 아직 변경되지 않음. 바꿔야함. MEPARK -->
	                    		</div>
	                    		<div class="time pl-ml inline">
	                      			<!-- <input type="time" class="timepicker" name="instTm" id="instTm" title="장착 희망시간 입력란" value="10:10:00"> -->
	                      			<select class="type06 w150" name="instTm" id="instTm" title="일시 선택" style="display: none" >
										<option value=""></option>
									</select>
	                    		</div>
	                  		</div>
	                	...
	                	<p class="validation">
	                  		<span><i class="ico08"></i>서비스 매니저가 연락 드리도록 하겠습니다.</span>
	                	</p>
	              	</div>
...
function returnAddrInfo(cbData) {
	...
	if(gbn == "B" || gbn == "P1" || gbn == "P2") {
		...
		var param = {iplAddr : cbData.popLoadAddr , itemCdArr : itemCdArr, itemCntArr : itemCntArr , mountCd : mountCd , mountDt : mountDt , mountTime : instTm , pageNo : '1' , searchGbn : "store", o2oYn : "N"};
